...
public class AudioManager : MonoBehaviour
{
    ...
    public void PlayAudioFx(SimulationEvent eventType, Action onAudioComplete = null)
    {
        ...
        bool canReplay = eventType == SimulationEvent.WrongAnswerFx || eventType == SimulationEvent.CorrectAnswerFx;
    ...
    {
        PlayAudioFx(SimulationEvent.WrongAnswerFx);
    }

    public void CorrectAnswerSound()
    {
        PlayAudioFx(SimulationEvent.CorrectAnswerFx);
    }
